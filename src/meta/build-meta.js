...
writeLines(generateSemanticsTypes(metaModel), "src/core/semantics-types_gen.ts");
writeLines(generatePolymorphicDispatcher(metaModel), "src/ide/editor/polymorphic-dispatcher_gen.tsx");
mapMap(metaModel, function (typeName) {
	writeLines(generateTypeWidgetSkeleton(typeName), "src/ide/editor/type-widgets/" + fileName(typeName) + ".tsx_gen");
});
